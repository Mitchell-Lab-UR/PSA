function scat_panel_narrow(xx,ndepth,nduration,narrow,broad,ncolo,bcolo,msize,vx,correlated,topname)
        %************
        ...
        if (correlated)
            ...
            plot(nuu(iz),xuu(iz),'k-','Color',ncolo,'Linewidth',2); hold on;
