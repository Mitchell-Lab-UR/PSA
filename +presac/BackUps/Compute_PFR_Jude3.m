function Info = Compute_PFR_Jude3(Info,Exp,H,plotsteps)
%******* 
%******  function Info = Compute_PFR_Jude3(Info,Exp,H)
%****
...
%****** if Exp is [], then just perform the plot and return
  ...
  for k = 1:NT
      Info.MeanLocBias{k} = mean(Info.LocationBias{k});  % use median, reduce outlier?
  end
  %*************  
